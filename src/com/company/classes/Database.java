...
public class Database {
    ...
    public static void serializeRightTriangle(RightTriangleList rightTriangleList) {
        try {
    ...
    public static RightTriangleList deserializeRightTriangle() throws IOException, ClassNotFoundException {
        ...
        ObjectInputStream objectInputStream = new ObjectInputStream(fileInputStream);
        RightTriangleList rightTriangleList = (RightTriangleList) objectInputStream.readObject();
        objectInputStream.close();
        fileInputStream.close();
